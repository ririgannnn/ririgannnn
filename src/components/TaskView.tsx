            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px', padding: '0 4px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span className="font-serif-cn" style={{ fontSize: '18px', fontWeight: 500, color: 'var(--text-primary)', letterSpacing: '0.02em' }}>
      ...
      {isEditing ? (
        <div className="space-y-2">
          <input
            ...
            style={{ background: 'var(--bg-deep)', color: 'var(--text-primary)', borderColor: 'var(--line)', fontSize: '16px', fontFamily: '"Noto Serif SC", "Source Han Serif SC", "思源宋体", serif' }}
            autoFocus
          />
          <textarea
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start gap-2">
                <span className="font-medium leading-relaxed" style={{ opacity: 0.55, textDecoration: 'line-through', color: 'var(--text-primary)', fontSize: '16px', fontFamily: '"Noto Serif SC", "Source Han Serif SC", "思源宋体", serif' }}>
                  {task.title}
                </span>
                <button
